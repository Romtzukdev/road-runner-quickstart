...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1219.358290933477; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -4580.894613381111; // x position of the perpendicular encoder (in tick units)
    }
